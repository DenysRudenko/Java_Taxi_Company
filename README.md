...
- so your Java files go in `src/`


---------------------------------------------
(1) Update ".env" settings for your MySQL setup
---------------------------------------------
...
---------------------------------------------
(2) locate the taxi.Main class and do a test run of this sample
---------------------------------------------

Java source (.java files) code located in: `/src/`
...
- note, the class congtaining the `main()` method to start your program's execution is declared in the `<mainClass>` element in the `pom.xml` Maven configuration file, which for this project is `<mainClass>tudublin.taxi.Main</mainClass>`
...
---------------------------------------------
(9) create/update your taxi.Main.java to insert and then retrieve objects from the databasew
---------------------------------------------	
...
So in our taxi.Main class we can create and insert a new object using the repository object all in one statement:
